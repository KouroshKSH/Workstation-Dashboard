...
public class ShowListOfProducts
{
    TableView<WarehouseProductsClass> tableOfProducts;
    VBox layout;

    public ShowListOfProducts()
    {
        ...
        layout.getChildren ().addAll (tableOfProducts, buttonClose);
    ...
    public ObservableList<WarehouseProductsClass> getWarehouseProducts()
    {
        ...
        //how the warehouse data file is written (as mentioned in the 'README.txt' file):
        //name|price|quantity|dateOfLastEntry|dateOfLastSelling|cost|itemsSold
        String[][] tableOfData = new String[stringArray.length][7];    //7 is the number of fields
